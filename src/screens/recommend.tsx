...
import { useAiRecommendation, useSaveRecommendation, getBeeTypeEnum } from '@/features/recommendation';
...
export default function RecommendScreen() {
  ...
  const [result, setResult] = useState<BeeRecommendationAiResponse | null>(null);
  ...
  const handleGetRecommendation = (crop: UserCrop) => {
    ...
    recommendMutation.mutate(
      ...
      },
      {
        ...
        onError: (error: any) => {
          Alert.alert('오류', error.response?.data?.message || '추천 요청에 실패했습니다');
        },
      }
    );
  };
  ...
  const beeInfo = result ? BEE_TYPE_INFO[result.beeType.toUpperCase()] || { icon: 'zap', color: '#7C4DFF' } : null;
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-100" edges={['bottom']}>
      ...
      <View className="flex-row items-center justify-between px-4 py-3 bg-white border-b border-gray-200">
        ...
        <Text className="text-lg font-semibold text-gray-900">수정벌 추천</Text>
        <View className="w-10" />
      </View>
          ...
          <>
              ...
              <Card className="mb-4">
                <View className="flex-row items-center">
                  ...
                  <View className="flex-1">
                    <Text className="text-base font-semibold text-gray-900">추천 기록</Text>
                    <Text className="text-sm text-gray-500">이전에 받은 추천 결과 보기</Text>
                  </View>
            ...
            {cropsLoading ? (
              <Card className="items-center py-12">
                ...
                <Text className="text-gray-500 mt-4">농지 정보를 불러오는 중...</Text>
              </Card>
              ...
              <Card className="items-center py-12">
                ...
                >
                  <Text className="text-white font-semibold">농지 등록하기</Text>
                </Pressable>
              </Card>
            ) : (
                  ...
                  <Card key={crop.id}>
                    ...
                    <View className="flex-row items-center mb-4 pb-4 border-b border-gray-100">
                      <View className="w-14 h-14 rounded-full bg-gray-100 items-center justify-center mr-3">
                        <Text className="text-2xl">{getCropEmoji(crop.name || '')}</Text>
                      </View>
                      <View className="flex-1">
                        <Text className="text-xl font-bold text-gray-900">
                          {crop.name || '미지정'}
                        </Text>
                        {crop.variety && crop.variety !== '0' && crop.variety.trim() !== '' && (
            ...
            <Card className="mb-4">
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-2xl font-bold text-gray-900">{result.beeType}</Text>
                </View>
              </View>
            </Card>
            ...
            <Card className="mb-4 items-center">
              <View className="flex-row items-center gap-2 bg-blue-50 px-5 py-3 rounded-full">
                ...
                <Text className="text-base font-semibold text-blue-600">
                  {formatDateKorean(result.inputStartDate)} ~ {formatDateKorean(result.inputEndDate)}
                </Text>
              </View>
            ...
            <Card className="mb-4">
              ...
              {result.characteristics.map((char, index) => (
                <View key={index} className="flex-row items-start mb-3">
                  ...
                  <Text className="flex-1 text-base text-gray-700 leading-6">{char}</Text>
                </View>
              ))}
            </Card>
            ...
            <Card className="mb-4">
              ...
              {result.usageTip.map((tip, index) => (
                <View key={index} className="flex-row items-start mb-3">
                  ...
                  <Text className="flex-1 text-base text-gray-700 leading-6">{tip}</Text>
                </View>
              ))}
            </Card>
            ...
            <Card className="mb-4">
              ...
              {result.caution.map((caution, index) => (
                <View key={index} className="flex-row items-start bg-amber-50 p-3 rounded-lg mb-2">
                  ...
                  <Text className="flex-1 text-sm text-gray-700 leading-5">{caution}</Text>
                </View>
              ))}
            </Card>
            ...
            <Card>
                  ...
                  saveMutation.mutate(requestData, {
                    onSuccess: () => {
                      ...
                      Alert.alert('저장 완료', '추천 결과가 저장되었습니다', [
                        ...
                        { text: '추천 기록 보기', onPress: () => router.push('/recommend-history') },
                      ]);
                    },
                    onError: (error: any) => {
              ...
              >
                {saveMutation.isPending ? (
                  ...
                  <>
                    ...
                    <Text className="text-base font-bold text-white">추천 결과 저장하기</Text>
                  </>
                )}
              </Pressable>
              ...
              <View className="flex-row gap-3 mt-3">
                ...
                >
                  ...
                  <Text className="text-sm font-semibold text-gray-600">구매처 찾기</Text>
                </Pressable>
                <Pressable
                  onPress={() => {
                    triggerHaptic('light');
                ...
                >
                  ...
                  <Text className="text-sm font-semibold text-gray-600">공유하기</Text>
                </Pressable>
              </View>

              <Pressable onPress={handleReset} className="items-center mt-4 py-2">
