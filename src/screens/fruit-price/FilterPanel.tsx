...
import {
  View, TouchableOpacity, ScrollView, Modal, Pressable,
} from "react-native";
  ...
  return (
    <>
      <TouchableOpacity
        ...
        disabled={disabled}
      >
        <PretendardFont weight="medium" style={{ fontSize: 13, color: "#334155", flex: 1 }} numberOfLines={1}>
          {selected ? selected.name : label}
        </PretendardFont>
        <PretendardFont style={{ color: "#94A3B8", fontSize: 12, marginLeft: 4 }}>▾</PretendardFont>
      </TouchableOpacity>
